...
def main():
    ...
    # Create assets
    table_asset, box_asset,_, ur3e_asset, pillar1_asset ,pillar2_asset ,pillar3_asset ,pillar4_asset = create_assets(gym, sim, asset_root, table_dims, box_size, ur3e_asset_file)
    ...
    envs, box_idxs, pillar1_idxs,pillar2_idxs,pillar3_idxs,pillar4_idxs, hand_idxs, init_pos_list, init_rot_list = create_envs(
        gym = gym, sim=sim, num_envs = num_envs, num_per_row = num_per_row, spacing = spacing, 
        table_asset = table_asset, box_asset = box_asset, 
